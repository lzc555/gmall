...
public class ItemService {
    ...
    public ItemVO queryItemVO(Long skuId) {
        ...
        // 根据id查询sku
        CompletableFuture skuCompletableFuture = CompletableFuture.supplyAsync(() -> {
        ...
        CompletableFuture spuCompletableFuture = skuCompletableFuture.thenAcceptAsync(sku -> {
            // 根据sku中的spuId查询spu
        ...
        CompletableFuture brandCompletableFuture = skuCompletableFuture.thenAcceptAsync(sku -> {
        ...
        CompletableFuture categoryCompletableFuture = skuCompletableFuture.thenAcceptAsync(sku -> {
        ...
        CompletableFuture saleAttrCompletableFuture = skuCompletableFuture.thenAcceptAsync(sku -> {
        ...
        // 根据spuId查询商品描述（海报）
        CompletableFuture descCompletableFuture = skuCompletableFuture.thenAcceptAsync(sku -> {
        ...
        CompletableFuture groupCompletableFuture = skuCompletableFuture.thenAcceptAsync(sku -> {
